		...
		<section id="content">
			...
			<nav class="event-menu">
				<ul>
			        ...
			        <li class="active"><a href="event_theater.jsp"><input type="button" value="극장"></a></li>
			        ...
			        <c:forEach begin="1" end="8">
			            <div class="event">
			            	...
			            	<div class="event-image">
				                <img src="https://img.megabox.co.kr/SharedImg/event/2023/09/15/H5Gp79G35D7EGI79myLrHbvhMyvCXVfG.jpg" alt="이벤트 썸네일">
				            </div>
				            <div>

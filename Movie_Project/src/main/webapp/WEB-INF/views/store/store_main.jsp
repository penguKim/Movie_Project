			...
			<div id="div_store_01">
				...
				<div id="div01">
					...
					<div class="snack_menu">
						<a href="store_push.jsp"><img alt="" src="${pageContext.request.contextPath }/resources/img/snack/우리패키지.jpg" width="310" height="250"><br>
						...
						<a href="store_basket.jsp"><img src="${pageContext.request.contextPath }/resources/img/cart2.png" width="60px" height="60px" class="cart_btn"></a>
						<a href="store_pay.jsp"><img src="${pageContext.request.contextPath }/resources/img/pay2.png" width="60px" height="60px" class="pay_btn"></a>
					</div>
					<div class="snack_menu">
						<a href=""><img alt="" src="${pageContext.request.contextPath }/resources/img/snack/나랑너패키지.jpg" width="310" height="250"><br>
					...
					<div class="snack_menu">
						<a href=""><img alt="" src="${pageContext.request.contextPath }/resources/img/snack/시네마패키지.jpg" width="310" height="250"><br>
				...
				<div id="div02">
					...
					<div class="snack_menu">
						<a href=""><img alt="" src="${pageContext.request.contextPath }/resources/img/snack/일반관람권.jpg" width="310" height="250"><br>
						<span>일반관람권</span><br><span id="snack_detail">일반 관람권 1매</span><br><br><span>10,000<span id="won">원</span></span></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/cart2.png" width="60px" height="60px" class="cart_btn"></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/pay2.png" width="60px" height="60px" class="pay_btn"></a>
					</div>
					<div class="snack_menu">
						<a href=""><img alt="" src="${pageContext.request.contextPath }/resources/img/snack/vip관람권.jpg" width="310" height="250"><br>
				...
				<div id="div03">
					...
					<!-- 가격까지 이미지로 다 넣어서 해야할듯 이미지 파일 편집 -->
					<div class="snack_menu">
						<a href=""><img alt="" src="${pageContext.request.contextPath }/resources/img/snack/스위트콤보.jpg" width="310" height="250"><br>
						<span>스위트콤보</span><br><span id="snack_detail">오리지널L + 탄산음료M2</span><br><br><span>10,000<span id="won">원</span></span></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/cart2.png" width="60px" height="60px" class="cart_btn"></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/pay2.png" width="60px" height="60px" class="pay_btn"></a>
					</div>
					<div class="snack_menu">
						<a href=""><img alt="" src="${pageContext.request.contextPath }/resources/img/snack/더블콤보.jpg" width="310" height="250"> <br>
						<span>더블콤보</span><br><span id="snack_detail">오리지널팝콘M + 탄산음료M2</span><br><br><span>10,000<span id="won">원</span></span></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/cart2.png" width="60px" height="60px" class="cart_btn"></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/pay2.png" width="60px" height="60px" class="pay_btn"></a>
					</div>
					<div class="snack_menu">
						<a href=""><img alt="" src="${pageContext.request.contextPath }/resources/img/snack/콜라M.jpg" width="310" height="250"> <br>
						<span>콜라M</span><br><span id="snack_detail">콜라M</span><br><br><span>10,000<span id="won">원</span></span></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/cart2.png" width="60px" height="60px" class="cart_btn"></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/pay2.png" width="60px" height="60px" class="pay_btn"></a>
					</div>
						<div class="snack_menu">
						<a href=""><img alt="" src="${pageContext.request.contextPath }/resources/img/snack/콜라L.jpg" width="310" height="250"><br>
						<span>콜라L</span><br><span id="snack_detail">콜라L</span><br><br><span>10,000<span id="won">원</span></span></a> 
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/cart2.png" width="60px" height="60px" class="cart_btn"></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/pay2.png" width="60px" height="60px" class="pay_btn"></a>
					</div>
					<div class="snack_menu">
						<a href=""><img alt="" src="${pageContext.request.contextPath }/resources/img/snack/오리지널M.jpg" width="310" height="250"><br>
						<span>오리지날팝콘 M</span><br><span id="snack_detail">오리지날팝콘 M</span><br><br><span>10,000<span id="won">원</span></span></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/cart2.png" width="60px" height="60px" class="cart_btn"></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/pay2.png" width="60px" height="60px" class="pay_btn"></a>
					</div>
					<div class="snack_menu">
						<a href=""><img alt="" src="${pageContext.request.contextPath }/resources/img/snack/오리지널L.jpg" width="310" height="250"><br>
						<span>오리지날팝콘 L</span><br><span id="snack_detail">오리지널팝콘 L</span><br><br><span>10,000<span id="won">원</span></span></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/cart2.png" width="60px" height="60px" class="cart_btn"></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/pay2.png" width="60px" height="60px" class="pay_btn"></a>
					</div>
					<div class="snack_menu">
						<a href=""><img alt="" src="${pageContext.request.contextPath }/resources/img/snack/카라멜M.jpg" width="310" height="250"><br>
						<span>캬라멜팝콘 M</span><br><span id="snack_detail">카라멜팝콘 M</span><br><br><span>10,000<span id="won">원</span></span></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/cart2.png" width="60px" height="60px" class="cart_btn"></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/pay2.png" width="60px" height="60px" class="pay_btn"></a>
					</div>
					<div class="snack_menu">
						<a href=""><img alt="" src="${pageContext.request.contextPath }/resources/img/snack/카라멜L.jpg" width="310" height="250"><br>
						<span>캬라멜팝콘 L</span><br><span id="snack_detail">카라멜팝콘 L</span><br><br><span>10,000<span id="won">원</span></span></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/cart2.png" width="60px" height="60px" class="cart_btn"></a>
						<a href=""><img src="${pageContext.request.contextPath }/resources/img/pay2.png" width="60px" height="60px" class="pay_btn"></a>
					</div>
					<div class="snack_menu">
						<a href=""><img alt="" src="${pageContext.request.contextPath }/resources/img/snack/반반.jpg" width="310" height="250"><br>

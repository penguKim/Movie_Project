 	$(function() {
		...
		let date = new Date();
		// 검색할 어제 날짜 호출
		let targetDt = date.toLocaleDateString().replace(/[\.\s]/g, '') - 1;
...
// 					$("#dailyBox").append("<option>" + movie.movieCd + ":" + movie.movieNm + "</option>");
				...
				$("#dailyBox").on("change", function() {
					let movieCd = $("#dailyBox option:selected").data("movie_id");
					console.log(movieCd);
